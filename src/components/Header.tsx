...
export function Header() {
  return (
    <header className='h-[84px] bg-white border-b border-slate-200 shadow-sm flex items-center fixed top-0 left-0 right-0 z-50'>
      <div className='w-full max-w-4xl mx-auto px-6 flex items-center justify-between'>
        ...
        <div className='flex items-center'>
          <a
            href='https://github.com/andrelimarn/shortly'
            target='_blank'
